...
typedef struct _StackRPC__V1__ControlRequest StackRPC__V1__ControlRequest;
typedef struct _StackRPC__V1__ControlResponse StackRPC__V1__ControlResponse;
typedef struct _StackRPC__V1__CueActionRequest StackRPC__V1__CueActionRequest;
typedef struct _StackRPC__V1__CueActionResponse StackRPC__V1__CueActionResponse;
typedef struct _StackRPC__V1__ListCuesRequest StackRPC__V1__ListCuesRequest;
typedef struct _StackRPC__V1__ListCuesResponse StackRPC__V1__ListCuesResponse;
typedef struct _StackRPC__V1__GetCuesRequest StackRPC__V1__GetCuesRequest;
typedef struct _StackRPC__V1__GetCuesResponse StackRPC__V1__GetCuesResponse;
typedef struct _StackRPC__V1__GetShowRequest StackRPC__V1__GetShowRequest;
typedef struct _StackRPC__V1__GetShowResponse StackRPC__V1__GetShowResponse;
typedef struct _StackRPC__V1__CueInfo StackRPC__V1__CueInfo;
...
typedef enum {
  ...
  STACK_RPC__V1__CONTROL_REQUEST__TYPE_GET_SHOW_REQUEST = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(STACK_RPC__V1__CONTROL_REQUEST__TYPE)
} StackRPC__V1__ControlRequest__TypeCase;

struct  _StackRPC__V1__ControlRequest
{
...
typedef enum {
  ...
  STACK_RPC__V1__CONTROL_RESPONSE__TYPE_GET_SHOW_RESPONSE = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(STACK_RPC__V1__CONTROL_RESPONSE__TYPE)
} StackRPC__V1__ControlResponse__TypeCase;

struct  _StackRPC__V1__ControlResponse
{
  ProtobufCMessage base;
 ...
 */
struct  _StackRPC__V1__CueActionRequest
{
  ProtobufCMessage base;
  int64_t cue_id;
...
struct  _StackRPC__V1__CueActionResponse
{
  ProtobufCMessage base;
};
 ...
 */
struct  _StackRPC__V1__ListCuesRequest
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _StackRPC__V1__ListCuesResponse
{
  ProtobufCMessage base;
  /*
   * Repeated cue UID
 ...
 */
struct  _StackRPC__V1__GetCuesRequest
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _StackRPC__V1__GetCuesResponse
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _StackRPC__V1__GetShowRequest
{
  ProtobufCMessage base;
};
 ...
 */
struct  _StackRPC__V1__GetShowResponse
{
  ProtobufCMessage base;
  /*
...
#define STACK_RPC__V1__CUE_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&stack_rpc__v1__cue_info__descriptor) \
    , 0, 0, 0, STACK_RPC__V1__CUE_STATE__Stopped, (char *)protobuf_c_empty_string, 0, 0, 0, STACK_RPC__V1__CUE_WAIT_TRIGGER__None, 0, (char *)protobuf_c_empty_string }
