...
static void stack_exec_cue_free_json(StackCue *cue, char *json_data)
{
	free(json_data);
}
...
void stack_exec_cue_register()
{
	...
	StackCueClass* exec_cue_class = new StackCueClass{ "StackExecCue", "StackCue", stack_exec_cue_create, stack_exec_cue_destroy, stack_exec_cue_play, NULL, NULL, stack_exec_cue_pulse, stack_exec_cue_set_tabs, stack_exec_cue_unset_tabs, stack_exec_cue_to_json, stack_exec_cue_free_json, stack_exec_cue_from_json, stack_exec_cue_get_error, NULL, NULL, NULL, stack_audio_cue_get_icon, NULL };
